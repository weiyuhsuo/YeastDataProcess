...
GENE_INFO_FILE = '/home/rhyswei/Code/YeastDataProcess/mac-yeast-data-process/BuildNumpy/data/Saccharomyces_cerevisiae.gene_info'
...
TSS_BED_FILE = '/home/rhyswei/Code/YeastDataProcess/mac-yeast-data-process/BuildNumpy/data/Sc_EPDnew_cleaned.bed'
...
ANNOT_FILE = '/home/rhyswei/Code/YeastDataProcess/mac-yeast-data-process/BuildNumpy/data/ncbiRefSeqCurated.txt'
...
EXPR_FILE = '/home/rhyswei/Code/YeastDataProcess/mac-yeast-data-process/BuildNumpy/data/sample_0105/20基因_matrix.xlsx'
...
COND_FILE = '/home/rhyswei/Code/YeastDataProcess/mac-yeast-data-process/BuildNumpy/data/sample_0105/20基因_sample.xlsx'
...
FIXED_MAPPING_FILE = '/home/rhyswei/Code/YeastDataProcess/mac-yeast-data-process/BuildNumpy/data/sample_0105/encoding_mapping_info.json'

# --- 输出目录配置 ---
# 输出文件的根目录（脚本会自动在此目录下创建带时间戳的子文件夹）
OUTPUT_BASE_DIR = '/home/rhyswei/Code/YeastDataProcess/mac-yeast-data-process/BuildNumpy/output'
...
MATRIX_SUMMIT_LIST = [
    {
        "matrix": '/home/rhyswei/Code/YeastDataProcess/mac-yeast-data-process/BuildNumpy/data/ATAC1_ver2_matrix.csv',
        "summit": '/home/rhyswei/Code/YeastDataProcess/mac-yeast-data-process/BuildNumpy/data/ATAC1_ver2.narrowPeak'
    },
]
...
def assign_expression_to_peaks_weighted(gene_pos_df, expr_data, chroms, summit_positions, sigma=500):
    ...
    for gene in tqdm(genes_for_g2p, desc="构建g2p矩阵（基于位置关系）"):
    ...
    for gene in tqdm(valid_genes_for_expr, desc="分配基因表达值"):
        gene_row = gene_pos_df[gene_pos_df['gene_name'] == gene]
        if gene_row.empty:
            continue
...
def main():
    ...
    if not use_fixed_mapping:
        ...
        preprocessor = None
        expected_cond_dim = fixed_mapping_info['total_features']
